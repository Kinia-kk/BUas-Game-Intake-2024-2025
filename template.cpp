...
{  
#ifdef _MSC_VER
    /*if (!redirectIO()) //I assume it is used for generating console window so in order to get rid of this window I commented it
        return 1;*/
#endif
	//printf( "application started.\n" );
	SDL_Init( SDL_INIT_VIDEO );// I don't know what it does so I just decided to keep it it might be important for the rest of code
#ifdef ADVANCEDGL
#ifdef FULLSCREEN
